                        ...
                        <div style={{ display: "flex", justifyContent: "space-around", }}>
                            ...
                            <div class="login-box">
                                ...
                                <div class="login-create-account">
                                    <p>
                                        <NavLink to={"/signup"}>
                                            <button value="Register An Account" name="dwfrm_login_register">
                                                Register An Account
						</button>
                                        </NavLink></p>
                            ...
                            <div>
                                <div className="login-box login-account ">
                                    <h2 className="section-header">Please Login
                                            ...
                                            <fieldset>
                                                <div className="form-row   required " data-required-text="Please enter your email address">
                                                    ...
                                                    <input className="input-text email-input required" id="" type="text" name="email"
                                                        onChange={handleChange} value={email} placeholder="Email Address" />
                                                ...
                                                <div className="form-row   required " data-required-text="Please enter your password">
                                                    ...
                                                    <input className="input-text-pw password-input required" id="dwfrm_login_password" type="password" name="password" onChange={handleChange} value={password} defaultValue maxLength={2147483647} placeholder="Password" />
                                                </div>
                                                <div className="form-row  label-inline  ">
                                                    <label htmlFor="dwfrm_login_rememberme">Remember Me</label>
                                                    <input className="input-checkbox" type="checkbox" name="dwfrm_login_rememberme" id="dwfrm_login_rememberme" defaultValue="true" />
                                                </div>
