...
function Cart() {
    ...
    if (cart.length > 0) {
        ...
        datatorender = cart.map(item => (
            <Cartcard results={item} />
        ...
        datatorender = <div className="cart-empty">
        ...
        <React.Fragment>
            ...
            <div id="wrapper" className="pt_cart">
                ...
                <div id="main" role="main" className="primary-focus clearfix">
                        ...
                        {login.status ?
                            <div className="shoppingcartcontainer">
                                ...
                                <form name="dwfrm_cart" id="cart-items-form">
                                    <fieldset>
                                        <button id="updatecart" className="visually-hidden" type="submit" value="dwfrm_cart_updateCart" name="dwfrm_cart_updateCart" />
                                        <table id="cart-table" className="item-list">
                                            <thead>
                                                <tr>
                                                    <th className="section-header" colSpan={2}>Product</th>
                                                    <th className="section-header">Quantity</th>
                                                    <th className="section-header">Price</th>
                                                    <th className="section-header header-total-price">Total</th>
                                            ...
                                            <tbody>
                                                ...
                                                )) : <h1 className="apnafont" style={{ textAlign: "center" }}> No Product </h1>
                                                ...
                                                <table className="order-totals-table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr className="order-total">
                                                            ...
                                                            <td>SR (working)</td>
                                                            <td><NavLink to={'/checkout'} ><button>Proceed to Checkout</button></NavLink></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                            ...
                            : <h1 className="apnafont" style={{ textAlign: "center" }}> Please login to access the cart </h1>}
                    ...
                    <div id="secondary" className="nav">
